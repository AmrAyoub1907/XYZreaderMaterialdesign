...
public class ArticleDetailFragment extends Fragment implements
    ...
    private void updateStatusBar() {
        int color = 0;
        if (fab != null && mTopInset != 0 && mScrollY > 0) {
                    ...
                    .get(mCursor.getString(ArticleLoader.Query.PHOTO_URL), new ImageLoader.ImageListener() {
                        ...
                        public void onResponse(ImageLoader.ImageContainer imageContainer, boolean b) {
                            ...
                            if (bitmap != null) {
                                ...
                                fab.setBackgroundColor(mMutedColor);//toolbar color
                                TextView titleView = (TextView) mRootView.findViewById(R.id.article_title);
                                collapsingToolbarLayout.setExpandedTitleTextAppearance(0);
    ...
    public int getUpButtonFloor() {
        if (mPhotoContainerView == null || fab.getHeight() == 0) {
            return Integer.MAX_VALUE;
        }

        // account for parallax
        return mIsCard
                ? (int) mPhotoContainerView.getTranslationY() + fab.getHeight() - mScrollY
                : fab.getHeight() - mScrollY;
    }
}
